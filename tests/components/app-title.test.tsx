...
describe('application title', () => {
  ...
  it('falls back to Test Manager for a blank configured title', async () => {
    const previousTitle = 'Host title';
    document.title = previousTitle;
    ...
    expect(app.refineConfig.options?.title).toEqual({ text: 'Test Manager' });
    expect(document.title).toBe('Test Manager');
